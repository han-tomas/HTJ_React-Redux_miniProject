...
function BoardInsert(){
    ...
    const writeClick=()=>{
        axios.get("http://localhost/board/board_insert_react",{
            params:{
                name:name,
                subject:subject,
                content:content,
        ...
        <Fragment>
            ...
            <div className="wrapper row3">
                <main className="hoc container clear">
                    <h2 style={{"color":"black"}} className={"text-center"}>새글 작성</h2>
                        ...
                        <table className={"table"}>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width={"85%"}>
                                        <textarea rows={"10"} cols={"56"} onChange={contentChange}></textarea>
                                    </td>
                                </tr>
                                <tr>
